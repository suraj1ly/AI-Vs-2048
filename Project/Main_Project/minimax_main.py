...
def place_random(bb):
    ...
    b[picked_location[0]][picked_location[1]] = f
    return b
    ...
    if is_maximising:
        ...
        for i in actions:
            ...
            if result[0] != board:
                ...
                return_value = minimax(temp_board, False, depth + 1, alpha, beta, (score + result[1] + numberofzeroes(temp_board * 4) + calculate(board)), action + " " + i, max_depth)
        ...
        for i in empty:
            ...
            return_value = minimax(temp_board, True, depth + 1, alpha, beta, (score + numberofzeroes(temp_board) * 4 + calculate(temp_board)), action, max_depth)
...
# t = minimax(board, True, 0, -1, +1, score, "", max_depth)
# print(t)
